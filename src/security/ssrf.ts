...
const BLOCKED_HOST_RE =
  /^(?:\[)?(?:127\.(?:\d{1,3}\.)*\d{1,3}|10\.(?:\d{1,3}\.)*\d{1,3}|172\.(?:1[6-9]|2\d|3[01])\.(?:\d{1,3}\.)*\d{1,3}|192\.168\.(?:\d{1,3}\.)*\d{1,3}|169\.254\.(?:\d{1,3}\.)*\d{1,3}|::1|::|::ffff:(?:7f(?:00)?|0?a00|ac1[0-9a-f]|c0a8|a9fe)[0-9a-f]*:[0-9a-f]+|::ffff:(?:127|10|172\.(?:1[6-9]|2\d|3[01])|192\.168|169\.254)\.(?:\d{1,3}\.)*\d{1,3}|fc[0-9a-f]{2}:[0-9a-f:]*|fd[0-9a-f]{2}:[0-9a-f:]*|fe[89ab][0-9a-f]:[0-9a-f:]*|0\.0\.0\.0|localhost)(?:\])?$/i;
